...
audio_init :: proc(a: ^Audio, base: string, volume: f32) {
	rl.InitAudioDevice()
...
audio_tick :: proc(a: ^Audio, ctx: ^sim.Context, w: ^sim.World, events: ^sim.Events, me: u8, camera: sim.Vec2) {
...
@(private = "file")
audio_sample :: proc(a: ^Audio, name: string) -> ^Sample {
